  ...
  <div class="page" @lifecycle="lifecycle">
    <div class="comment">
      ...
      <div class="box">
        ...
        >
          <div class="comment_box" v-for="(item) in msg" :key="item.id">
            <div class="left" @click="goNotice(item.id)">
              <img class="img" src="../../static/n.png" style="width:100px;height:100px" alt />
    ...
    getNotice(){
      ...
      storage.getItem("id",(res)=>{
        ...
        //  console.log("id是---"+JSON.parse(res.data).id);
             const body = JSON.stringify({ id:JSON.parse(res.data).id });
                stream.fetch({
                    method: 'POST',
                    url: 'http://10.12.84.20:3001/notice/findMyTeacherNotice',
                    type:'json',
                    body: body,
                    headers:{
            ...
            // stream.fetch({
            //     method: 'GET',
            //     url: 'http://10.12.84.20:3001/notice/findNoticeAll',
            //     type:'json'
            //     }, function(res) {
