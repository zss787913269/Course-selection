package eeui.android.networkTransfer.module.transfer;
...
public class TransferModule {
    ...
    public void download(String s, final ModuleResultListener listener) {
        ...
        try {
            BOUNDARY = Util.getMD5("app" + new Date().getTime());
...
//                            result.setBytesSent(totalBytes);
    ...
    private File getDownloadFile(Uri targetUri) throws IOException {
        ...
        try {
            fileName = Util.getMD5("app/transfer/download" + System.currentTimeMillis()) + v;
        } catch (NoSuchAlgorithmException e) {
            e.printStackTrace();
            fileName = "app/transfer/download" + System.currentTimeMillis() + v;
        }
