...
//
    ...
    if (!target ||[target hasPrefix:@"/"]) {
        ...
        filePath = [filePath stringByAppendingString:@"/app/download"];
        
        self.randomPath = filePath;
        NSString *boundary = [self md5:[@"apptransferdownload" stringByAppendingFormat:@"%lf",[[NSDate date] timeIntervalSince1970]]];
...
//    NSData *fileData;
    if ([fileUrl.absoluteString hasPrefix:@"app://static/image"]) {
...
- (void)uploadWithData:(NSData *)data fileUrl:(NSURL *)fileUrl params:(NSDictionary *)params serverurl:(NSURL *)serverurl filename:(NSString *)filename mimeType:(NSString *)mimeType{
    ...
    NSString *boundary = [self md5:[@"app" stringByAppendingFormat:@"%lf",[[NSDate date] timeIntervalSince1970]]];
    //cookie
...
//        [downloadProgress setObject:[NSNumber numberWithBool:lengthComputable] forKey:@"lengthComputable"];
        ...
        [downloadProgress setObject:@100 forKey:@"status"];
...
//        [uploadProgress setObject:[NSNumber numberWithBool:true] forKey:@"lengthComputable"];
        ...
        [uploadProgress setObject:@100 forKey:@"status"];
...
//    NSMutableDictionary* uploadResult;
    if (self.transferTYpe == Nat_TRANSFER_UPLOAD) {
        ...
        if ((self.responseCode >= 200) && (self.responseCode < 300)) {
            self.uploadback(nil,@{@"status":@100, @"progress":@1});
        ...
        if (self.targetFileHandle) {
            self.downloadback(nil,@{@"status":@100, @"progress":@1});
